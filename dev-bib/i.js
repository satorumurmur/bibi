(() => {
    ...
    document.addEventListener('bibi:readied',     Eve => console.log(`BiB/i: Readied. - ${ Eve.detail.Bibis.length } Bibi${ Eve.detail.Bibis.length > 1 ? 's' : '' }.`));
    document.addEventListener('bibi:loaded',      Eve => console.log(`BiB/i: Loaded. - ${  Eve.detail.Bibis.length } Bibi${ Eve.detail.Bibis.length > 1 ? 's' : '' }.`));
    document.addEventListener('bibi:timed-out',   Eve => console.log(`BiB/i: Timed Out.`                                                                              ));
